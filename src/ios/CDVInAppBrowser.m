...
- (void)open:(CDVInvokedUrlCommand*)command
{
    ...
    if (url != nil) {
        ...
        //[NSURL fileURLWithPath:[url stringByReplacingPercentEscapesUsingEncoding:NSUTF8StringEncoding]];
...
- (void)navigateTo:(NSURL*)url
{
    ...
    //    url=[NSURL fileURLWithPath:pathForTemporaryFile(path.lastPathComponent)];
    //    NSData* inData=[body dataUsingEncoding:NSUTF16StringEncoding];
    //    absoluteUrl = [NSURL fileURLWithPath:url];
